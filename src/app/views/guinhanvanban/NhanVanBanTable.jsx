...
export default function NhanVanBanTable() {
    ...
    const [listDangVien, setListDangVien] = useState([
        { "value0": 1, "value1": "Thực hiện QD 60", "value2": "15/02/2023 ", value3: 'Trần Hoàng Sơn', value4: 'Đảng bộ tỉnh Long An' },
        { "value0": 1, "value1": "Thực hiện QD 60", "value2": "18/02/2023", value3: 'Huỳnh Quang Cường', value4: 'Đảng bộ tỉnh Long An' },
    ]);
    ...
    return (
        <Container>
            <Breadcrumb routeSegments={[{ name: "Nhận văn bản", path: "/par/dangvien" }]} />
            <SimpleCard >
