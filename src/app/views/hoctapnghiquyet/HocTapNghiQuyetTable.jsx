...
export default function HocTapNghiQuyetTable() {
    ...
    const [listDangVienMD, setListDangVienMD] = useState([
        { "value0": 1, "value2": "Trần Hoàng Sơn", "value21": "Đã đánh giá", "value3": "15/02/2023 12:15 ", "value4": " 15/02/2023 14:45", "value1": " Hội nghi trực tuyến toàn quốc nghiên cứu học tập quán triệt Nghi quyết Hội nghị lần thứ năm Ban Chấp hành Trung Ương Đảng khóa XIII", },
        { "value0": 1, "value2": "Huỳnh Chí Tường", "value21": "Đã đánh giá", "value3": "13/02/2023 08:15 ", "value4": " 13/02/2023 11:45", "value1": "Học tập nghị quyết của Đảng - nhiệm vụ quan trọng của Đảng và hệ thống chính trị", },
        { "value0": 1, "value2": "Phạm Phú Quý", "value21": "Đã đánh giá", "value3": "12/02/2023 07:15 ", "value4": " 12/02/2023 10:45", "value1": "Nâng cao hiệu quả học tập, nghiên cứu, quán triệt, triển khai thực hiện Nghị quyết của Đảng", }
    ]);
    ...
    return (
        <Container>
            ...
            <Breadcrumb routeSegments={[{ name: "Học tập nghị quyết", path: "/par/dangvien" }]} />
            ...
            <SimpleCard >
                ...
                <Table autoHeight={true} data={listDangVien} id="table" className='table table-pointer' loading={loading} headerHeight={38} rowHeight={50} shouldUpdateScroll={false}>
                    ...
                    <Column flexGrow={3} verticalAlign="middle">
                        <CustomHeaderCell2>Chủ đề</CustomHeaderCell2>
                        <CustomCell >{(rowData, rowIndex) => (<div className='div-flex'><img className='me-2 w-25' src="https://cdn-icons-png.flaticon.com/512/2232/2232688.png"></img>{rowData.value1}</div>)}</CustomCell>
                    </Column>
