...
export default function Buoc33Table() {
    ...
    return (
        <Container>
            ...
            <SimpleCard >
                ...
                <Divider />
                <br />
                <Steps current={2} className="pointer">
                    ...
                    <Grid item lg={12} md={12} sm={12} xs={12} >
                        <Grid container spacing={1} className="div-form">
                            ...
                            <Grid item lg={12} md={12} sm={12} xs={12} >
                                ...
                                <SunEditor
                                    defaultValue='<p>1. B&iacute; thư chi bộ triển khai nội dung sinh hoạt chi bộ</p><p>&nbsp;</p><p>2. Chi bộ Thảo luận</p><p>&nbsp;</p><p>3. Kết luận của chủ tr&igrave;</p>'
                            ...
                            <Grid item lg={12} md={12} sm={12} xs={12} >
                                <div className='displayflexcenter pt-5'>
                                    ...
                                    <Button color="red" appearance="primary" className='div-flex bor-ra-3 w-140' size="md">
                                        <Icon className="icon icon-search-2">save</Icon> Lưu biên bản
                                    </Button>
