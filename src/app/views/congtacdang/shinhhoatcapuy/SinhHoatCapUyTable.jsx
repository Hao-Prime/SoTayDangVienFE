...
export default function SinhHoatCapUyTable() {
    ...
    const [listDangVienMD, setListDangVienMD] = useState([
        ...
        { "value1": 1, "value2": "Đã diễn ra", "value21": "Đã đánh giá", "value3": "13/02/2023 08:15 ", "value4": " 13/02/2023 11:45", "value5": "Thực hiện thủ tục gói thầu VNPT HIS", },
    ...
    return (
        <Container>
            ...
            <Breadcrumb routeSegments={[{ name: "Sinh hoạt cấp ủy", path: "/par/dangvien" }]} />
            ...
            <SimpleCard >
                ...
                <Table wordWrap="break-word" height={450} data={listDangVien} id="table" className='table table-pointer' loading={loading} headerHeight={38} rowHeight={50} shouldUpdateScroll={false}>
                    ...
                    <Column width={180} resizable verticalAlign="middle" align="center">
                        ...
                        <CustomCell>{rowData => <p className={"bg-tim" + rowData.value1}>{rowData.value21}</p>}</CustomCell>
